...
{/* Left part */}
      ...
      <div className='fixed left-40 top-10 h-screen w-[300px] overflow-hidden flex items-center justify-center'> {/* Fixed left part */}
        <Template
          title="GRUPVERSE"
          desc1="One Stop Social Media For Teams."
          desc2="Login using the below option."
          formtype="login"
